package com.example.ashishrpa.moneymanager;
...
public class UpdateexpenseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.example.ashishrpa.moneymanager.R.layout.activity_updateexpense);
        et_searchcategory_updateexpenseactivity = (EditText) findViewById(com.example.ashishrpa.moneymanager.R.id.et_searchcategory_updateexpenseactivity);
        et_searchdate_updateexpenseactivity = (EditText) findViewById(com.example.ashishrpa.moneymanager.R.id.et_searchdate_updateexpenseactivity);
        et_searchmonth_updateexpenseactivity = (EditText) findViewById(com.example.ashishrpa.moneymanager.R.id.et_searchmonth_updateexpenseactivity);

        et_newmonth_updateexpenseactivity = (EditText) findViewById(com.example.ashishrpa.moneymanager.R.id.et_newmonth_updateexpenseactivity);
        et_newweek_updateexpenseactivity = (EditText) findViewById(com.example.ashishrpa.moneymanager.R.id.et_newweek_updateexpenseactivity);
        et_newdate_updateexpenseactivity = (EditText) findViewById(com.example.ashishrpa.moneymanager.R.id.et_newdate_updateexpenseactivity);
        et_newcategory_updateexpenseactivity = (EditText) findViewById(com.example.ashishrpa.moneymanager.R.id.et_newcategory_updateexpenseactivity);
        et_newamount_updateexpenseactivity = (EditText) findViewById(com.example.ashishrpa.moneymanager.R.id.et_newamount_updateexpenseactivity);
        et_newyear_updateexpenseactivity = (EditText) findViewById(com.example.ashishrpa.moneymanager.R.id.et_newyear_updateexpenseactivity);

        bt_search_updateexpenseaactivity = (Button) findViewById(com.example.ashishrpa.moneymanager.R.id.bt_search_updateexpenseactivity);
        bt_update_updateexpenseaactivity = (Button) findViewById(com.example.ashishrpa.moneymanager.R.id.bt_update_updateexpenseactivity);
        bt_clear_updateexpenseactivity = (Button) findViewById(com.example.ashishrpa.moneymanager.R.id.bt_clear_updateexpenseactivity);
