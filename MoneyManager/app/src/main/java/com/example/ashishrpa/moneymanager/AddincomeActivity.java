...
public class AddincomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.example.ashishrpa.moneymanager.R.layout.activity_addincome);
        et_monthinput = (EditText) findViewById(com.example.ashishrpa.moneymanager.R.id.et_monthinput);
        et_incomeinput = (EditText) findViewById(com.example.ashishrpa.moneymanager.R.id.et_incomeinput);
        bt_addincome = (Button) findViewById(com.example.ashishrpa.moneymanager.R.id.bt_addincome);
        tv_statusincome = (TextView) findViewById(com.example.ashishrpa.moneymanager.R.id.tv_statusincome);
