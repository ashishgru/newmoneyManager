...
public class DailyreportsearchActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.example.ashishrpa.moneymanager.R.layout.activity_dailyreportsearch);
        et_month_dailyreportsactivity = (EditText) findViewById(com.example.ashishrpa.moneymanager.R.id.et_month_dailyreportsactivity);
        et_week_dailyreportsactivity = (EditText) findViewById(com.example.ashishrpa.moneymanager.R.id.et_week_dailyreportsactivity);
        et_date_dailyreportsactivity = (EditText) findViewById(com.example.ashishrpa.moneymanager.R.id.et_date_dailyreportsactivity);

        bt_search_dailyreportsactivity = (Button) findViewById(com.example.ashishrpa.moneymanager.R.id.bt_search_dailyreportsactivity);
        bt_calculatedailyexpense = (Button) findViewById(com.example.ashishrpa.moneymanager.R.id.bt_calculatedailyexpense);
        bt_clear_dailyreportsactivity=(Button) findViewById(com.example.ashishrpa.moneymanager.R.id.bt_clear_dailyreportsactivity);
        bt_calculatedailyexpense.setClickable(false);

        tv_showdailyreport = (TextView) findViewById(com.example.ashishrpa.moneymanager.R.id.tv_showdailyreport);
        tv_totaldailyexpense = (TextView) findViewById(com.example.ashishrpa.moneymanager.R.id.tv_totaldailyexpense);
        tv_dailybalance = (TextView) findViewById(com.example.ashishrpa.moneymanager.R.id.tv_dailybalance);
