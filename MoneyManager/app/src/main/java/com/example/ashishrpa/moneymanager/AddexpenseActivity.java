...
public class AddexpenseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.example.ashishrpa.moneymanager.R.layout.activity_addexpense);

        et_enteryear = (EditText) findViewById(com.example.ashishrpa.moneymanager.R.id.et_enteryear);
        et_entermonth = (EditText) findViewById(com.example.ashishrpa.moneymanager.R.id.et_entermonth);
        et_enterweek = (EditText) findViewById(com.example.ashishrpa.moneymanager.R.id.et_enterweek);
        et_enterdate = (EditText) findViewById(com.example.ashishrpa.moneymanager.R.id.et_enterdate);
        et_entercategory = (EditText) findViewById(com.example.ashishrpa.moneymanager.R.id.et_entercategory);
        et_enterexpense = (EditText) findViewById(com.example.ashishrpa.moneymanager.R.id.et_enterexpense);
        bt_addexpenseactivitybutton = (Button) findViewById(com.example.ashishrpa.moneymanager.R.id.bt_addexpenseactivitybutton);
