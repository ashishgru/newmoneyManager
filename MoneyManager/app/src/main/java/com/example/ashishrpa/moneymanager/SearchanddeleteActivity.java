...
public class SearchanddeleteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.example.ashishrpa.moneymanager.R.layout.activity_searchanddelete);
        et_searchcategory = (EditText) findViewById(com.example.ashishrpa.moneymanager.R.id.et_searchcategory);
        et_searchmonth = (EditText) findViewById(com.example.ashishrpa.moneymanager.R.id.et_searchmonth);
        et_searchdate = (EditText) findViewById(com.example.ashishrpa.moneymanager.R.id.et_searchdate);

        tv_searchresults = (TextView) findViewById(com.example.ashishrpa.moneymanager.R.id.tv_searchresults);

        bt_searchbutton = (Button) findViewById(com.example.ashishrpa.moneymanager.R.id.bt_searchcategory);
        bt_deletebutton = (Button) findViewById(com.example.ashishrpa.moneymanager.R.id.bt_deletecategory);
        bt_clear_searchanddeleteactivity= (Button) findViewById(com.example.ashishrpa.moneymanager.R.id.bt_clear_searchanddeleteactivity);
