...
public class ReportsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.example.ashishrpa.moneymanager.R.layout.activity_reports);
        bt_dailyreportsearch_reportactivity = (Button) findViewById(com.example.ashishrpa.moneymanager.R.id.bt_dailyreportsearch_reportactivity);
        bt_monthlyreportsearch_reportactivity = (Button) findViewById(com.example.ashishrpa.moneymanager.R.id.bt_monthlyreportsearch_reportactivity);
        bt_weeklyreportsearch_reportactivity = (Button) findViewById(com.example.ashishrpa.moneymanager.R.id.bt_weeklyreportsearch_reportactivity);
        bt_yearlyreportsearch_reportactivity = (Button) findViewById(com.example.ashishrpa.moneymanager.R.id.bt_yearlyreportsearch_reportactivity);
