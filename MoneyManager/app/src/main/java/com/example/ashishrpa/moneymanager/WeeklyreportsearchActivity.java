...
public class WeeklyreportsearchActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.example.ashishrpa.moneymanager.R.layout.activity_weeklyreportsearch);

        et_month_weeklyreportsactivity = (EditText) findViewById(com.example.ashishrpa.moneymanager.R.id. et_month_weeklyreportsactivity);
        et_week_weeklyreportsactivity = (EditText) findViewById(com.example.ashishrpa.moneymanager.R.id.et_week_weeklyreportsactivity);

        bt_search_weeklyreportsactivity = (Button) findViewById(com.example.ashishrpa.moneymanager.R.id.bt_search_weeklyreportsactivity);
        bt_calculateweeklyexpense = (Button) findViewById(com.example.ashishrpa.moneymanager.R.id.bt_calculateweeklyexpense);
        bt_clear_weeklyreportsactivity = (Button) findViewById(com.example.ashishrpa.moneymanager.R.id.bt_clear_weeklyreportsactivity);
        bt_clear_weeklyreportsactivity.setClickable(false);

        tv_showweeklyreport = (TextView) findViewById(com.example.ashishrpa.moneymanager.R.id.tv_showweeklyreport);
        tv_totalweeklyexpense = (TextView) findViewById(com.example.ashishrpa.moneymanager.R.id.tv_totalweeklyexpense);
        tv_weeklybalance= (TextView) findViewById(com.example.ashishrpa.moneymanager.R.id.tv_weeklybalance);
