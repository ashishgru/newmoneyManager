...
public class MonthlyreportsearchActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.example.ashishrpa.moneymanager.R.layout.activity_monthlyreportsearch);

        et_month_monthlyreportsactivity = (EditText) findViewById(com.example.ashishrpa.moneymanager.R.id.et_month_monthlyreportsactivity);
        et_year_monthlyreportsactivity = (EditText) findViewById(com.example.ashishrpa.moneymanager.R.id.et_year_monthlyreportsactivity);


        bt_search_monthlyreportsactivity = (Button) findViewById(com.example.ashishrpa.moneymanager.R.id.bt_search_monthlyreportsactivity);
        bt_calculatemonthlyexpense = (Button) findViewById(com.example.ashishrpa.moneymanager.R.id.bt_calculatemonthlyexpense);
        bt_clear_monthlyreportsactivity = (Button) findViewById(com.example.ashishrpa.moneymanager.R.id.bt_clear_monthlyreportsactivity);

        bt_calculatemonthlyexpense.setClickable(false);

        tv_showmonthlyreport = (TextView) findViewById(com.example.ashishrpa.moneymanager.R.id.tv_showmonthlyreport);
        tv_totalmonthlyexpense = (TextView) findViewById(com.example.ashishrpa.moneymanager.R.id.tv_totalmonthlyexpense);
        tv_monthlybalance = (TextView) findViewById(com.example.ashishrpa.moneymanager.R.id.tv_monthlybalance);
    ...
    public void monthlybalance(View view){
        ...
        if(monthly_income.equals("addincome")){
            ...
            float monthlyincomeFloat = Float.parseFloat(monthly_income);
            float totalmonthlyexpense = totalexpense;
            float monthly_savings = monthlyincomeFloat - totalmonthlyexpense;
