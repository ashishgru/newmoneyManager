...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.example.ashishrpa.moneymanager.R.layout.activity_main);

        ActionBar actionBar = getSupportActionBar();
        actionBar.setTitle("Money Manager");
        actionBar.setLogo(com.example.ashishrpa.moneymanager.R.drawable.moneymanagerlogo);
        actionBar.setDisplayShowTitleEnabled(true);
        actionBar.setDisplayShowHomeEnabled(true);
        actionBar.setDisplayUseLogoEnabled(true);
        actionBar.setDisplayHomeAsUpEnabled(true);

        bt_addexpense_mainactivity = (Button) findViewById(com.example.ashishrpa.moneymanager.R.id.bt_addexpense_mainactivity);
        bt_showexpense_mainactivity = (Button) findViewById(com.example.ashishrpa.moneymanager.R.id.bt_showexpense_mainactivity);
        bt_showreports_mainactivity = (Button) findViewById(com.example.ashishrpa.moneymanager.R.id.bt_showreports_mainactivity);
        bt_searchanddelete_mainactivity = (Button) findViewById(com.example.ashishrpa.moneymanager.R.id.bt_searchanddelete_mainactivity);
        bt_updateexpense_mainactivity = (Button) findViewById(com.example.ashishrpa.moneymanager.R.id.bt_updateexpense_mainactivity);
        bt_income_mainactivity = (Button) findViewById(com.example.ashishrpa.moneymanager.R.id.bt_income_mainactivity);
