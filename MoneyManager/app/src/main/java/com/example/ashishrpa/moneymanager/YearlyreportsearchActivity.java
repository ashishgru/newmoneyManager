...
public class YearlyreportsearchActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.example.ashishrpa.moneymanager.R.layout.activity_yearlyreportsearch);

        et_year_yearlyreportsactivity = (EditText) findViewById(com.example.ashishrpa.moneymanager.R.id.et_year_yearlyreportsactivity);


        bt_search_yearlyreportsactivity = (Button) findViewById(com.example.ashishrpa.moneymanager.R.id.bt_search_yearlyreportsactivity);
        bt_calculateyearlyexpense = (Button) findViewById(com.example.ashishrpa.moneymanager.R.id.bt_calculateyearlyexpense);
        bt_clear_yearlyreportsactivity = (Button) findViewById(com.example.ashishrpa.moneymanager.R.id.bt_clear_yearlyreportsactivity);

        bt_calculateyearlyexpense.setClickable(false);

        tv_showyearlyreport = (TextView) findViewById(com.example.ashishrpa.moneymanager.R.id.tv_showyearlyreport);
        tv_totalyearlyexpense = (TextView) findViewById(com.example.ashishrpa.moneymanager.R.id.tv_totalyearlyexpense);
        tv_yearlybalance = (TextView) findViewById(com.example.ashishrpa.moneymanager.R.id.tv_yearlybalance);
